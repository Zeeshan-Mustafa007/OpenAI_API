    ...
    return (
        ...
        >
            <div className="flex items-end gap-3">
                ...
                <div className="flex justify-center gap-2">
                    ...
                    <div className="flex items-center relative group">
                        <button
                            ...
                            type="button"
                            className={`flex h-full min-w-8 items-center gap-1 justify-center p-2 rounded-full border ${
                                webSearch === true
                ...
                <textarea
                    rows={1}
                    className="flex-grow resize-none text-gray-100 rounded-xl px-4 py-2 focus:outline-none placeholder-gray-400"
